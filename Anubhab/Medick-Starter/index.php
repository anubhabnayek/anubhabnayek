    ...
    <div class="w3l-banner-content">
      <div class="container">
        <div class="bannerhny-info text-center">
          ...
          <a class="btn btn-style btn-white mt-sm-5 mt-4" href="about.php">
            Read More</a>
        </div>
      </div>
    </div>
    ...
    <div class="container py-lg-5 py-md-4 py-2">
      <div class="row w3l-content-inf mt-lg-5 pt-lg-5">
        ...
        <div class="col-lg-7 w3l-content-right pl-lg-5 mt-lg-4">
          ...
          <a class="btn btn-style btn-outline-light mt-sm-5 mt-4 mr-2" href="about.php">
            Read More</a>
        </div>
      </div>
    </div>
          ...
          <div class="card img">
            <div class="card-body img">
              ...
              <div class="blog-des mt-4">
                <h6 class="card-cap mb-2"><a href="blog-single.php">Investigations</a></h6>
                <h5 class="card-title mb-2"><a href="blog-single.php">The Right Choice For Your Health Care Needs.</a>
                </h5>
        ...
        <div class="col-lg-4 col-md-6 about-in blog-grid-info text-left mt-5">
          <div class="card img">
            <div class="card-body img">
              ...
              <div class="blog-des mt-4">
                <h6 class="card-cap mb-2"><a href="blog-single.php">Researches</a></h6>
                <h5 class="card-title mb-2"><a href="blog-single.php">The Right Choice For Your Health Care Needs.</a>
                </h5>
                <ul class="admin-post mb-3">
                  <li>
        ...
        <div class="col-lg-4 col-md-6 about-in blog-grid-info text-left mt-5">
          <div class="card img">
            <div class="card-body img">
              ...
              <div class="blog-des mt-4">
                <h6 class="card-cap mb-2"><a href="blog-single.php">Your Health </a></h6>
                <h5 class="card-title mb-2"><a href="blog-single.php">The Right Choice For Your Health Care Needs.</a>
                </h5>
                <ul class="admin-post mb-3">
                  <li>
