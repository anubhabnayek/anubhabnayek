...
<h2 style="color: blue; text-align: center;">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" name="date_of_birth"data-bvalidator="required,yyyy-mm-dd"  placeholder="Enter D.O.B">
  </div>
  <div class="form-group">
  ...
  <input type="number" name="number" class="form-control" data-bvalidator="required,number" placeholder="Enter pincode">
  </div>
