    ...
    <div class="row"> 
        <div class="col-md-3 border-right">
         <div class="d-flex flex-column align-items-center text-center p-3 py-5">
            <img class="rounded-circle mt-5" src="image\pexels-pixabay-220453.jpg" height="150px" weight="150px"> 
            <span class="font-weight-bold">Anubhab</span>
            <span class="text-black-50">anubhab12@bbb.com</span>
            <span> 
            </span>
        </div> 
       </div> 
         <div class="col-md-5 border-right"> 
            <div class="p-3 py-5">
             ...
             <div class="row mt-2">  
                <div class="col-md-6">
                    <label class="labels">Firstame</label>
